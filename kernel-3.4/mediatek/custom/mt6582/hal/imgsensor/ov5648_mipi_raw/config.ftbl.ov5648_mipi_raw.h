...
#endif
    //==========================================================================
#ifdef HW_LCD_COMPENSATE  
    //  LCD compensate  
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(  
        KEY_AS_(MtkCameraParameters::KEY_LCD_COMPENSATION),   
        SCENE_AS_DEFAULT_SCENE(  
            ITEM_AS_DEFAULT_(MtkCameraParameters::LCD_COMPENSATION_MODE_OFF),   
            ITEM_AS_VALUES_(  
                 MtkCameraParameters::LCD_COMPENSATION_MODE_OFF,  
                MtkCameraParameters::LCD_COMPENSATION_MODE_AUTO,  
            )  
        ),   
     )  
#endif  
    //==========================================================================
#ifdef HW_SUB_CAMERA_FLIP
	//==========================================================================
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(  
        KEY_AS_(MtkCameraParameters::KEY_SUB_CAM_FLIP),   
            SCENE_AS_DEFAULT_SCENE(  
            ITEM_AS_DEFAULT_(MtkCameraParameters::SUB_CAM_FLIP_MODE_OFF),   
            ITEM_AS_VALUES_(  
                MtkCameraParameters::SUB_CAM_FLIP_MODE_ON,  
                MtkCameraParameters::SUB_CAM_FLIP_MODE_OFF,  
            )  
        ),   
    )  
	FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(  
        KEY_AS_(MtkCameraParameters::KEY_SUB_CAM_FLIP_SUPPORTED),   
            SCENE_AS_DEFAULT_SCENE(  
            ITEM_AS_DEFAULT_(MtkCameraParameters::SUB_CAM_FLIP_MODE_SUPPORTED),   
            ITEM_AS_VALUES_(  
                MtkCameraParameters::SUB_CAM_FLIP_MODE_SUPPORTED,  
                MtkCameraParameters::SUB_CAM_FLIP_MODE_NOT_SUPPORTED,  
            )  
        ),   
    ) 
#endif
