...
MSDK_SCENARIO_ID_ENUM ov8830CurrentScenarioId = MSDK_SCENARIO_ID_CAMERA_PREVIEW;
...
static void OV8830_Set_Dummy(const kal_uint16 iPixels, const kal_uint16 iLines)
{
	...
	switch (ov8830CurrentScenarioId)
	{
...
//	;;;;;;;;;;;;;Any modify please inform to OV FAE;;;;;;;;;;;;;;;	
	...
	OV8830_write_cmos_sensor(0x380d, 0x18);	// ; HTS															   
	OV8830_write_cmos_sensor(0x380e, 0x07);	// ; VTS = 1994 													   
	OV8830_write_cmos_sensor(0x380f, 0x80);	// ; VTS	
	OV8830_write_cmos_sensor(0x3810, 0x00);	// ; H OFFSET = 4													   
	OV8830_write_cmos_sensor(0x3811, 0x04);	// ; H OFFSET														   
	OV8830_write_cmos_sensor(0x3812, 0x00);	// ; V OFFSET = 4													   
	OV8830_write_cmos_sensor(0x3813, 0x04);	// ; V OFFSET														   
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
	...
	spin_lock(&ov8830_drv_lock);
   ov8830CurrentScenarioId = ScenarioId;
   spin_unlock(&ov8830_drv_lock);
...
UINT32 OV8830SetTestPatternMode(kal_bool bEnable)
{
#ifdef OV8830_DRIVER_TRACE
		SENSORDB("OV8830SetTestPatternMode£¬Test pattern enable:%d\n",bEnable);
#endif	

	if(bEnable)
		OV8830_write_cmos_sensor(0x5E00, 0x80);													   
	else		
		OV8830_write_cmos_sensor(0x5E00, 0x00);		
							 ...
							 UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
	...
	switch (FeatureId)
	{
		...
		case SENSOR_FEATURE_GET_TEST_PATTERN_CHECKSUM_VALUE:
			*pFeatureReturnPara32= OV8830_TEST_PATTERN_CHECKSUM;
			*pFeatureParaLen=4;
			break;

		case SENSOR_FEATURE_SET_TEST_PATTERN:
			OV8830SetTestPatternMode((BOOL)*pFeatureData16);
			break;
		/**New add by hesong*****/
		default:
			break;
