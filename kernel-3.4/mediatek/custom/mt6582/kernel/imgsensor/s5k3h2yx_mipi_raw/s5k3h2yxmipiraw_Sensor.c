...
UINT32 S5K3H2YXMIPISetTestPatternMode(kal_bool bEnable)
{
   if(bEnable)
   	{
   		S5K3H2YXMIPI_write_cmos_sensor(0x0600, 0x00);
		S5K3H2YXMIPI_write_cmos_sensor(0x0601, 0x02);
   	}
   else
   	{
   		S5K3H2YXMIPI_write_cmos_sensor(0x0600, 0x00);
		S5K3H2YXMIPI_write_cmos_sensor(0x0601, 0x00);
   	}
}
                                                                ...
                                                                UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
    ...
    switch (FeatureId)
    {
		...
		case SENSOR_FEATURE_SET_TEST_PATTERN:
            S5K3H2YXMIPISetTestPatternMode((BOOL)*pFeatureData16);        	
            break;
		case SENSOR_FEATURE_GET_TEST_PATTERN_CHECKSUM_VALUE:			
			*pFeatureReturnPara32=S5K3H2YX_TEST_PATTERN_CHECKSUM;			
			*pFeatureParaLen=4;			
