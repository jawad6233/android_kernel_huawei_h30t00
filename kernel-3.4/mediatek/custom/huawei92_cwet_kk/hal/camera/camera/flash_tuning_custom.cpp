...
FLASH_PROJECT_PARA& cust_getFlashProjectPara(int aeMode, NVRAM_CAMERA_STROBE_STRUCT* nvrame)
{
	...
	para.engLevel.torchDuty = 3; //  187MA // 1;
	...
	para.engLevel.pfDuty = 6; //6=328.13ma; //8; // 8=468.75mA //1;
	para.engLevel.mfDutyMax = 16; //16=843.75mA; //20;  // 20=1031mA //9;
	//para.engLevel.pfDuty = 5; //5=281.25ma; //8; // 8=468.75mA //1;
	//para.engLevel.mfDutyMax = 14; //14=750mA; //20;  // 20=1031mA //9;
	...
	para.engLevel.pfDutyL = 8; //1;
	para.engLevel.mfDutyMaxL = 10;  //2;
	...
	para.coolTimeOutPara.tabId[3]=20;
	para.coolTimeOutPara.tabId[4]=32;
